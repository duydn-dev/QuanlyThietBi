<template>
    <div id="kt_quick_panel" class="kt-quick-panel" v-if="false">
        <a id="kt_quick_panel_close_btn" href="#" class="kt-quick-panel__close"
        ...
        <div class="kt-quick-panel__content">
            <div class="tab-content">
                ...
                <div id="kt_quick_panel_tab_logs" class="tab-pane fade kt-scroll" role="tabpanel">
