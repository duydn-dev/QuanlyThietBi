        ...
        <div class="kt-portlet kt-portlet--height-fluid">
            <div class="kt-portlet__head">
                <div class="kt-portlet__head-label">
                    <h3 class="kt-portlet__head-title">Trường tuyển sinh theo nhóm dịch vụ</h3>
                </div>
            </div>
            ...
            getData() {
                ...
                this.$http({
                    ...
                    .then(response => {
                        ...
                        this.seriesSchoolService = _.map(response.data.listAbroadSchoolByType, 'count');
                        this.chartOptionsSchoolService.labels = _.map(response.data.listAbroadSchoolByType, 'key');
                        this.countChange++;
                        this.isLoaded = true;
                    })
                    .catch(err => {
