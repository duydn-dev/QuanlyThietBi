                            ...
                            <div class="text-white">
                                ...
                                <h4 class="mb-4">
                                    <label style="margin-bottom: 0px;">
                                        <animated-number-display :value="data.totalMemberPassExam" />
                                    </label>
                                </h4>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card card-finance">
                        <div class="card-body">
                            ...
                            <div class="text-white">
                                <h6 class="text-uppercase mb-3">Tổng trường</h6>
                                <h4 class="mb-4">
                                    <label style="margin-bottom: 0px;">
                                        <animated-number-display  :value="data.totalAbroadSchool" />
                                    </label>
                                </h4>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card card-finance">
                        <div class="card-body">
                            ...
                            <div class="text-white">
                                <h6 class="text-uppercase mb-3">Tổng kỳ tuyển</h6>
                                <h4 class="mb-4">
                                    <label style="margin-bottom: 0px;">
                                        <animated-number-display :value="data.totalInterviewPeriod" />
                                    </label>
                                </h4>
                            </div>
                        </div>
