<template>
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor row">
        ...
        <div class="row ml-5">
            <div class="col-3">
                <fselect v-if="!isBranch && appSettings.branchList" v-model="objData.branchId" :options="appSettings.branchList" placeholder="---Tất cả chi nhánh---"></fselect>
            </div>
            <!--<button type="button" class="btn btn-success">
                <RouterLink to="/dashboard/abroad">
                    <span style="color:white">Tổng quan</span>
                </RouterLink>
            </button>
        ...
        <div id="kt_content" class="kt-content  kt-grid__item kt-grid__item--fluid">
            <div class="kt-container  kt-grid__item kt-grid__item--fluid">
                        ...
                        <div class="kt-portlet kt-portlet--height-fluid">
                            <div class="kt-widget14">
                                ...
                                <div class="kt-widget14__chart" style="width:100%">
                                    <apexchart ref="chartbar" type=bar width="100%" :options="chartOptionsBar" :series="seriesBar" v-if="isLoadedBarChart" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="kt-portlet kt-portlet--height-fluid">
                            <div class="kt-widget14">
                                ...
                                <div class="kt-widget14__content">
                                    <div class="kt-widget14__chart" style="width: 100%;">
                                        <apexchart type=donut width="80%" :options="chartOptionsProfile" :series="seriesProfile" v-if="seriesProfile.length>0" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        ...
                        <div class="kt-portlet kt-portlet--height-fluid">
                            <div class="kt-widget14">
                                ...
                                <div class="kt-widget14__content">
                                    <div class="kt-widget14__chart" style="width: 100%;">
                                        <apexchart ref="chart" type=donut width="100%" :options="chartOptions" :series="series" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <!--End::Row-->
                <!--Begin::Row-->
                <statByBranch @data="getDataProfile" :branchId="objData.branchId" :key="objData.branchId" />
                <!--End::Row-->
                <!--Begin::Row-->
                <!--End::Row-->
                <!--End::Dashboard 2-->
...
<script>
    ...
    export default {
        ...
        watch: {
            'mode'(val) {
                if (val == 1) this.$router.push(`/dashboard/abroad-persional`);
            },
            'objData.branchId'() {
                this.doStatistics();
        ...
        methods: {
            ...
            getDataMemberByEnrollmentPeriod() {
                ...
                this.$http({
                    ...
                    if (this.seriesBar) this.seriesBar[0].data.length = 0;
                    var count = 0;
                    var sumOther = 0;
                    ...
                    this.$refs.chartbar.updateSeries(this.seriesBar);
                });
            },
            getDataForChart() {
                //statistics
            ...
            getDataProfile(val) {
                ...
                this.seriesProfile.push(this.SumProfileInput(val));
                this.chartOptionsProfile.labels.push('Đang nhập');
                this.seriesProfile.push(this.SumProfileTranslate(val));
                this.chartOptionsProfile.labels.push('Đang dịch');
                this.seriesProfile.push(this.SumProfileBuild(val));
                this.chartOptionsProfile.labels.push('Đang dựng');
                this.seriesProfile.push(this.SumProfile(val) - this.SumProfileInput(val) - this.SumProfileTranslate(val) - this.SumProfileBuild(val));
            ...
            SumProfile(val) {
                let sum = 0;
                _.each(val, (o) => {
                    sum = sum + o.profileStatus.length;
                })
                return sum;
            },
            SumProfileInput(val) {
                let sum = 0;
                _.each(val, (o) => {
                    if (o.profileStatus.length > 0) {
                        let count = _.countBy(o.profileStatus, (i) => {
                            return i == 1;
                        });
                        if (count.true)
                            sum += count.true;
