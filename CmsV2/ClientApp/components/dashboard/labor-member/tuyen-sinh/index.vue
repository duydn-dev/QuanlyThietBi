                            ...
                            <div class="text-white">
                                ...
                                <h4 class="mb-4">
                                    <label style="margin-bottom: 0px;">
                                        <animated-number-display v-if="data.countMemberWaitOrder" :value="data.countMemberWaitOrder" />
                                    </label>
                                </h4>
                            </div>
                        </div>
                    ...
                    <div class="card card-finance">
                        <div class="card-body">
                            ...
                            <div class="text-white">
                                ...
                                <h4 class="mb-4">
                                    <label style="margin-bottom: 0px;">
                                        <animated-number-display v-if="data.listCancelMember" :value="data.listCancelMember.length" />
                                    </label>
                                </h4>
                            </div>
                        </div>
                    ...
                    <div class="card card-finance">
                        <div class="card-body">
                            ...
                            <div class="text-white">
                                ...
                                <h4 class="mb-4">
                                    <label style="margin-bottom: 0px;">
                                        <animated-number-display :value="data.countCollaborator" />
                                    </label>
                                </h4>
                            </div>
                        </div>
                            ...
                            <div class="kt-widget4">
                                <table class="kt-datatable__table table-striped table-hover table-bordered" width="100%">
                                    ...
                                    <tbody class="kt-datatable__body">
                                        <tr v-for="(item,index) in data.listNewMember" :key="index">
                                            <td>
                                                {{item.code}}
                                            </td>
                                            <td>
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="kt-widget4">
                                <table class="kt-datatable__table table-striped table-hover table-bordered" width="100%">
                                    ...
                                    <tbody class="kt-datatable__body">
                                        <tr v-for="(item,index) in data.listCancelMember" :key="index">
                                            <td>
                                                {{item.code}}
                                            </td>
                                            <td>
