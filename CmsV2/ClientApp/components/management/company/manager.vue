    ...
    <managementwrapper>
        ...
        <div class="app-search">
            <div class="topbar-search position-relative">
                <input type="text" placeholder="Nhập từ khóa tìm kiếm" class="form-control ipt-search"
                    v-model="objData.keyword"
                    @keyup.13="getListData()"> 
                <button type="submit" class="btn-search"><img src="/assets-v2/images/icon-search.svg" alt=""></button>
            </div>
        </div>
                                        ...
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-12 text-end mb-3">
                                                    <button class="btn btn-primary" @click="openPopup()"><i class="fa fa-plus"></i> Tạo mới</button>
...
<script>
    ...
    export default {
        ...
        created() {
            if(this.appSettings.companies && this.appSettings.currentCompany.isSystem && this.isPermission(['companyManagement'])){
                this.getListData();
            }
            else {
