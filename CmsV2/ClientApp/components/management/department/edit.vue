<template>
    <modalv2 :title="form.id > 0 ? 'Sửa phòng ban' : 'Thêm phòng ban'" @close="closePopup()">
        <div slot="body">
            <ul class="lst-info">
                        <li class="d-flex flex-column">
                            <label class="txt-tit">Tên phòng ban</label>
                            <input class="txt-ipt" placeholder="Nhập tên phòng ban" v-model="form.name">
                        </li>
                        <li class="d-flex flex-column">
                            <label class="txt-tit">Phòng cấp cha</label>
                            <fselect
                        ...
                        <li class="two-col d-flex">
                            <div class="col-input d-flex flex-column">
                                <label class="txt-tit">Trưởng đơn vị</label>
                                <select
                                    v-if="listUsers"
                            ...
                            <div class="col-input d-flex flex-column">
                                <label class="txt-tit">Trạng thái</label>
