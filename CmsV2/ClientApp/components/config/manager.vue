<template>
    <wrapper>
        <template slot="header">
            <div class="kt-subheader__main" v-if="!configGroupCode">
                <h3 class="kt-subheader__title">Quản lý danh mục dữ liệu</h3>
                        ...
                        <div class="kt-grid__item kt-wizard-v2__aside" v-if="!configGroupCode">
                            ...
                            <div class="kt-wizard-v2__nav">
                                <div class="kt-wizard-v2__nav-items">
                                    <a v-for="(group, index) in listConfig"
                                       :key="index"
                                       class="kt-wizard-v2__nav-item"
                                       href="javascript:;"
                                       data-ktwizard-type="step"
                                       :data-ktwizard-state="activeTabIndex == index ? 'current' : 'pending'"
                                        ...
                                        <div class="kt-wizard-v2__nav-body">
                                            ...
                                            <div class="kt-wizard-v2__nav-label">
                                                <div class="kt-wizard-v2__nav-label-title">
                                                    ...
                                                    <span class="ml-1">({{ group.configs.length }})</span>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <div id="category-type2"
                                    ...
                                    <div v-for="(item, indexConfig) in currentGroup.configs"
                                        ...
                                        <div class="kt-widget4__info">
                                            <a class="kt-widget4__username">{{item.configName}}</a>
