; (function (win, $) {
    ...
    var customCalendalJs = function () {
        ...
        $('.fc-listMonth-button').click(function() {
            $(this).parents('.box').removeClass('calen-gridweek calen-gridday calen-gridmonth');
            $(this).parents('.box').addClass('calen-lstmonth');
        });
    };
    ...
    var selectTabView = function () {
        ...
        // $('.tab-lst .btn-grid').click(function () {
        //     $(this).parents('.calendar-wrap').find('.tab-contentGrid .fc-dayGridMonth-button').addClass('fc-button-active');

        //     $(this).parents('.calendar-wrap').find('.tab-contentGrid .fc-timegrid').removeClass('fc-timeGridDay-view');
        //     $(this).parents('.calendar-wrap').find('.tab-contentGrid .fc-timegrid').addClass('fc-dayGridMonth-view');
            
        // });

        $('.tab-contentList .btn-selTime .fc-button').click(function () {
            $(this).parents('.calendar-wrap').find('.tab-lst').show();
            $(this).parents('.calendar-wrap').find('.btn-selTime .fc-button').removeClass('fc-button-active');
            $(this).addClass('fc-button-active');

            if($('.tab-contentGrid').hasClass('is-active')){
                $(this).parents('.calendar-wrap').find('.tab-lst').find('.btn-grid').addClass('on');
                $(this).parents('.calendar-wrap').find('.tab-lst').find('.btn-list').removeClass('on');
            }

            if($('.tab-contentList').hasClass('is-active')){
                $(this).parents('.calendar-wrap').find('.tab-lst').find('.btn-list').addClass('on');
                $(this).parents('.calendar-wrap').find('.tab-lst').find('.btn-grid').removeClass('on');
            }
        });

        $('.fc-timeGridDay-button').click(function () {
            $(this).parents('.calendar-wrap').find('.tab-lst').hide();
            // $(this).parents('.calendar-wrap').find('.tab-contentList .fc-view-harness').remove();
            $(this).parents('.tab-contentGrid').find('.btn-selTime .fc-timeGridDay-button').removeClass('fc-button-active');
            

            $(this).parents('.calendar-wrap').find('.btn-selTime .fc-button').removeClass('fc-button-active');
            $(this).parents('.calendar-wrap').find('.fc-timeGridDay-button').addClass('fc-button-active');

            $(this).parents('.calendar-wrap').find('.tab-contentGrid').removeClass('is-active');
            $(this).parents('.calendar-wrap').find('.tab-contentList').addClass('is-active');
        });
    };
