...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    (function (TokenType) {
        ...
        TokenType[TokenType["SEMO2LON_TOKEN"] = 27] = "SEMO2LON_TOKEN";
        TokenType[TokenType["LEFT_SQUARE_BRACKET_TOKEN"] = 28] = "LEFT_SQUARE_BRACKET_TOKEN";
        TokenType[TokenType["RIGHT_SQUARE_BRACKET_TOKEN"] = 29] = "RIGHT_SQUARE_BRACKET_TOKEN";
        TokenType[TokenType["UNO2DE_RANGE_TOKEN"] = 30] = "UNO2DE_RANGE_TOKEN";
    ...
    var SEMO2LON_TOKEN = { type: TokenType.SEMO2LON_TOKEN };
    ...
    var Tokenizer = /** @class */ (function () {
        ...
        Tokenizer.prototype.consumeUnicodeRangeToken = function () {
            ...
            if (questionMarks) {
                ...
                return { type: TokenType.UNO2DE_RANGE_TOKEN, start: start_1, end: end };
            }
            ...
            if (this.peekCodePoint(0) === HYPHEN_MINUS && isHex(this.peekCodePoint(1))) {
                ...
                return { type: TokenType.UNO2DE_RANGE_TOKEN, start: start, end: end };
            }
            else {
                return { type: TokenType.UNO2DE_RANGE_TOKEN, start: start, end: start };
            }
        };
