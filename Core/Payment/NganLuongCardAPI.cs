...
{
    public class NganLuongCardAPI
    {        
        private NganLuongCardAPI() { }
        public static ResponseInfoCard CardChage(RequestInfoCard info)
        {
            String result = HttpPost(info);
            return ParserResult(result);
        }
        #region Function  Lib
        private static ResponseInfoCard ParserResult(string output)
        {
            ResponseInfoCard info = new ResponseInfoCard();
        ...
        private static String GetParamPost(RequestInfoCard info)
        {
        ...
        private static String HttpPost(RequestInfoCard request)
        {
            ...
            HttpWebRequest myRequest =
              (HttpWebRequest)WebRequest.Create(request.ApiUrl);
